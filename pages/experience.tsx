...
export default function Experience({
	...
	return (
		<>
			<Head>
				<title>
					{lang ? "My Portfolio - Experience" : "Mi Portafolio - Experiencia"}
				</title>
				...
				<div className="w-full p-7 flex flex-col gap-5">
					...
					<p className="text-xl font-sans">
						...
						{lang
							...
							: "Motivado, buen trabajador en equipo con grandes dotes organizativas e interpersonales."}
						<br />
						<br />
						{lang
							...
							: "Siempre en busca de nuevas oportunidades para mejorar mis habilidades, obtener reconocimiento por mis conocimientos y valores y asumir responsabilidades adicionales y crecer profesionalmente. responsabilidades y crecer profesionalmente"}
					</p>
				</div>
